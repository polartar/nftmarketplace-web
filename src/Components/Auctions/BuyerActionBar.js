...
const BuyerActionBar = () => {
    ...
    return (
        <div>
                ...
                <Card.Body>
                    <div className="d-flex flex-row justify-content-between">
                        <div className={`my-auto fw-bold ${awaitingAcceptance || isComplete ? 'mx-auto' : ''}`} style={{color:'#000'}}>
                            ...
                            {listing.state === auctionState.ACTIVE && bidHistory.length > 0 && !awaitingAcceptance &&
                                <><h6>Current Bid:</h6> <span className="fs-3 ms-1">{ethers.utils.commify(listing.highestBid)} CRO</span></>
                            }
            ...
            { openBidDialog && user &&
                <div className='checkout'>
                    <div className='maincheckout'>
                        <button className='btn-close' onClick={() => setOpenBidDialog(false)}>x</button>
                        ...
                        <button className='btn-main lead mb-5' onClick={executeBid(bidAmount)} disabled={!!bidError || executingBid}>
                            {executingBid ?
                                <>
                                    Confirming Bid...
                                    <Spinner animation="border" role="status" size="sm" className="ms-1">
            ...
            <div className='checkout'>
                <div className='maincheckout'>
                    <button className='btn-close' onClick={() => setOpenRebidDialog(false)}>x</button>
                    <div className='heading'>
                        <h3>Increase Bid</h3>
                    </div>
                    ...
                    <div className='heading'>
                        <p>Total Bid</p>
                        <div className='subtotal'>
                            {(parseFloat(myBid()) + parseFloat(rebidAmount))} CRO
                        </div>
                    </div>

                    <button className='btn-main lead mb-5' onClick={executeBid(rebidAmount)} disabled={!!bidError || executingBid}>
                        {executingBid ?
                            <>
                                Confirming Bid...
                                <Spinner animation="border" role="status" size="sm" className="ms-1">
