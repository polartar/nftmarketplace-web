...
const MyNftCard = ({
    ...
    return (
        <div className="card eb-nft__card h-100 shadow">
            <img onClick={() => navigateTo(nftUrl())} src={croSkullRedPotionImageHack(nft.address, nft.image)} className="card-img-top marketplace" style={{cursor:'pointer'}} alt={nft.name} />
            {nft.rank &&
